...
SVC_NAME="actions.runner.kenlasko-pangolin.github-runner-l3QxZgSWCGTGa.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (kenlasko-pangolin.github-runner-l3QxZgSWCGTGa)"
